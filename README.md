...
The application performs basic validation to improve reliability.
...
* 🔐 **User Authentication** — Login and password system
* 🔄 **Fund Transfer** — Transfer money between accounts
* 💵 **Interest Calculation** — Savings account interest
* 📊 **Account Statements** — Generate detailed statements
* 💾 **Persistent Storage** — Save data between program executions
* 🖥️ **GUI** — Java Swing/JavaFX interface
* 🌐 **Web Application** — Convert into a web-based banking system
